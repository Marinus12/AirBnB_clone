...
class TestCity_instantiation(unittest.TestCase):
	...
	def test_new_instance_stored_in_objects(self):
		self.assertIn(City(), models.storage.all().vlaues())
	...
	def test_two_cities_uique_ids(self):
		cy1 = City()
		cy2 = City()
	...
	def test_two_cities_different_updated_at(self):
		...
		sleep(0.05)
		cy2 = City()
		self.assertLess(cy1.updated_at, cy.updated_at)
	...
	def test_instantiation_with_kwargs(self):
		dt = datetime.today()
		dt_iso = dt.isoformat()
		cy = City(id="345"m created_at=dt_iso, updated_at=dt_iso)
...
class TestCity_save(unittest.TestCase):
	...
	def test_one_save(self):
		...
		self.assetLess(first_updated_at, second_updated_at)
		sleep(0.05)
		cy.save()
		self.assetLess(second_updated_at, cy.updated_at)
...
class TestCity_to_dict(unittest.TestCase):
	...
	def test_to_dict_type(self):
		self.assetTrue(dict, type(City().to_dict()))
