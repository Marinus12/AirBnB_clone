...
class TestPlace_instantiation(unittest.TestCase):
	"""Unittests for testung instantiation of the Place class."""
	...
	def test_city_id_is_public_class_attribue(self):
		pl = Place()
		self.assertEqual(str, type(Place.city_id))
		self.assertIn("city_id", dir(pl))
		self.assertNotIn("city_id", pl.__dict__)

	def test_user_id_is_public_class_attribte(self):
		pl = Place()
	...
	def test_description_is_public_class_attribue(self):
		pl Place()
		self.assertEqual(str, type(Place.description))
		self.assertIn("description", dir(pl))
		self.assertNotIn("description", pl.__dict__)

	def test_number_rooms_is_public_class_attribue(self):
		pl = Place()
