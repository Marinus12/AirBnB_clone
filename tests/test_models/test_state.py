#!/usr/bin/python3
"""Defins unittests for models/state.py
...
class TestState_instantiation(unittest.TestCase):
	...
	def test_name_is_public_class_attribute(self):
		...
		self.assertIn("name", st.__dict__)
	...
	def test_two_states_different_created_at(self):
		...
		sleep(0.05)
		st2 = State()
		self.assertLess(st1.cretated_at, st2.created_at)
	...
	def test_str_representation(self):
		...
		self.assetIn("'id': '123456'", ststr)
		self.assertIn("'created_at': " + dt_repr, ststr)
		self.assertIn("'updated_at': " + dt_repr, ststr)

	def test_args_unused_(self):
		st = State(None)
...
class TestState_save(unittest.TestCase):
	...
	def test_save_updates_file(self):
		...
		with open("file.json", "r") as f:
			self.assetIn(stid, f.read())

	
class TestState_to_dict(unittest.TestState):
	...
	def test_to_dict_contains_added_attributes(self):
		...
		self.assertEqual("my_number", st.to_dict())
